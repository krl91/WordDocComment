...
## Workflow 1b — Fusion depuis plusieurs versions (Doc0 + Doc1 + Doc2)

Quand les commentaires sont répartis sur **deux versions sources** (Doc0 et Doc1),
chaîner le script deux fois — aucun changement de code nécessaire :
